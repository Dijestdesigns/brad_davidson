    ...
    <section class="wrapper site-min-height">
        <div class="row">
            <div class="col-lg-12">
                <div class="border-head">
                    <h3><i class="fa fa-angle-right"></i> <?php echo e(__('Folders')); ?></h3>
                </div>
            </div>
        </div>
        ...
        <div class="row">
            <div class="col-lg-12">
                ...
                <form class="form-inline search-form" method="__GET" action="<?php echo e(route('folders.index')); ?>">
                    <div class="">
                        <div class="form-group">
                            ...
                            <?php if($isFiltered == true): ?>
                                <a href="<?php echo e(route('folders.index')); ?>" class="btn btn-light">
                    ...
                    <div class="pull-right add-new-button">
                        <a class="btn btn-primary" href="<?php echo e(route('folders.create')); ?>"><i class="fa fa-plus"></i></a>
                    </div>
                </form>
        ...
        <div class="row">
            <div class="col-md-12">
                <div class="content-panel">
                    <div class="col-md-8">
                        <h4><i class="fa fa-angle-right"></i>&nbsp;<?php echo e(__('Total')); ?> <?php echo e($total); ?> <?php echo e(__('Folders')); ?></h4>
                    </div>
                    <div class="col-md-4">
                                ...
                                <?php if(!empty($records) && !$records->isEmpty()): ?>
                                    <?php $__currentLoopData = $records; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $record): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <tr>
                                            ...
                                            ?>
                                            <td><?php echo e(implode(", ", $tags)); ?></td>
                                            <td><?php echo e($record->notes); ?></td>
                                            <td><?php echo e($record->qty); ?></td>
                                            <td><?php echo e($record->userCreatedBy->name); ?></td>
                                            <td class="form-inline">
                                                <a href="<?php echo e(route('folders.edit', $record->id)); ?>" title="<?php echo e(__('Edit')); ?>">
                                                    <i class="fa fa-edit fa-2x"></i>
                                                </a>
                                                &nbsp;
                                                <form action="<?php echo e(route('folders.destroy', $record->id)); ?>" method="POST">
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH E:\Jaydeep Mor\Work\Jessica\BRAD DAVIDSON\brad_davidson\resources\views/folders/index.blade.php ENDPATH**/ ?>