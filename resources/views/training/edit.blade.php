        ...
        <div class="row">
            <div class="col-lg-12">
                <div class="border-head">
                    <h3><i class="fa fa-angle-right"></i> {{ __('Training Edit') }}</h3>
                </div>
            </div>
        </div>
        ...
        <div class="row">
            <div class="col-lg-12">
                <div class="content-panel">
                    <form class="form-group p-10" action="{{ route('training.update', $record->id) }}" method="POST">
                        @method('PATCH')
                        @csrf
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                ...
                                <div class="row">
                                    <div class="col-md-3">
                                        <label>
                                            <input type="radio" class="{{ $errors->has('is_daily') ? ' is-invalid' : '' }}" name="is_daily" {{ old('is_daily', $record->is_daily) == App\Training::IS_DAILY ? 'checked=""' : '' }} value="{{ App\Training::IS_DAILY }}" />
                                            {{ __('Daily') }}
                                        </label>
                                        <br />
                                        <label>
                                            <input type="radio" class="{{ $errors->has('is_daily') ? ' is-invalid' : '' }}" name="is_daily" {{ (old('is_daily', $record->is_daily) == '0') ? 'checked=true' : '' }} value="{{ App\Training::IS_NOT_DAILY }}" />
                                            {{ __('Custom Day') }}
                                        </label>
