    ...
    <section class="wrapper site-min-height">
        <div class="row">
            <div class="col-lg-12">
                <div class="border-head">
                    <h3><i class="fa fa-angle-right"></i> {{ __('Stock Levels') }}</h3>
                </div>
            </div>
        </div>
        ...
        <div class="row">
            <div class="col-lg-12">
                ...
                <form class="form-inline search-form" method="__GET" action="{{ route('stock_levels.index') }}">
                    <div class="">
                        <div class="form-group">
                            ...
                            @if($isFiltered == true)
                                <a href="{{route('stock_levels.index')}}" class="btn btn-light">
                                    ...
                                    @foreach ($records as $index => $record)
                                        <tr>
                                            ...
                                            <td class="form-inline">
                                                <a href="{{ route('inventory.index', ['s' => $record->name, 'q' => $record->qty]) }}" title="{{ __('Check') }}" target="__blank">
