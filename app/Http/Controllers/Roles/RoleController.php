...
class RoleController extends \App\Http\Controllers\BaseController
{
    ...
    public function index(Request $request)
    {
        ...
        return view('roles.list', ['roles' => $roles, 'total' => $total, 'term' => $term]);
    }
    ...
    public function create()
    {
        ...
        return view('roles.create', ['groups' => $permissions]);
    }
    ...
    public function show($id)
    {
        ...
        if ($role) {
            ...
            return view('roles.show', ['role' => $role, 'groups' => $permissions]);
        } else {
    ...
    public function edit($id)
    {
        ...
        if ($role) {
            return view('roles.edit', ['role' => $role, 'groups' => $permissions]);
        } else {
            return redirect('roles')->with('error',__("Role not found!"));
        }
    }
